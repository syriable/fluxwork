<div>
    ...
    <div x-data="LivewireUIModal()" x-on:close.stop="setShowPropertyTo(false)"
        x-on:keydown.escape.window="show && closeModalOnEscape()" x-show="show" class="fixed inset-0 z-30 overflow-y-auto"
        style="display: none;">
        <div class="flex items-center justify-center min-h-dvh px-4 pt-4 pb-10 text-center sm:block sm:p-0">
            ...
            <div x-show="show && showActiveComponent" x-transition:enter="ease-out duration-300"
                ...
                class="relative inline-block w-full align-bottom text-start overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:w-full"
